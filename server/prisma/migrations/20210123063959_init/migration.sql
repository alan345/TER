/*
  ...
  - Added the required column `resetPasswordRequest` to the `User` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_User" (
    ...
    "resetPasswordRequest" DATETIME NOT NULL,
