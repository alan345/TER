  ...
  return (
    <div className="flex flex-col items-center justify-center mt-64">
      ...
      <p className="text-lg text-center mb-4">
        Love this? Hate this? Can't decide? Either way, let me know!
      </p>
      {/* <img
      ...
      <p className="text-md text-center mb-4">
        You can reach me at{" "}
        <a
          href="https://github.com/alan345/TER/issues"
      ...
      <p className="text-sm text-gray-600 text-center">
        (Disclaimer: Shouting may not yield a response, but I appreciate the
        enthusiasm!)
      </p>

      <p className="text-sm text-gray-600 text-center mt-10">
        Genreated by Chat GPT 4o mini
      </p>
    </div>
  );
}
